Will I pause next time a change seems obviously useful to me?

Yesterday, I changed the meeting point for our neighborhood cleanup.

I didn't ask the volunteer who had made the signs.
...
Pause after “eighty copies.” Keep the final uncertainty quiet and unresolved.

Optional external polish

Don't upload private or sensitive material unless you're comfortable sharing it with Claude.

Replace `[PASTE ENGLISH SCRIPT HERE]` with the finalized English section above, from the teleprompter body through light delivery notes.
